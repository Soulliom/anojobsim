/*Just a small little project I hope to complete and not get bored of. Make a job sim, promotions, risks,
spendings, rent, casinos, etc. Create cmd prompt UI, include rand functions, seed implementation, classes,
voids, pointers, preprocessor, etc. Try your best and please for the love of god finish a single project.
*/
